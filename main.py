...
import json
from train_and_test import train_generator, test_generator, train_simulator, test_simulator
...
parser.add_argument('--T_path', default='data/shape_spec_5000.mat', type=str)
